...
var Image ='path://M7.2,2.4 L12,2.4 L7.2,9.59960711 L2.4,9.59960711 L7.2,2.4 Z'
var maxData = 2000;
...
option = {
    ...
    yAxis: {
        data: ['硬件服务', '操作系统服务', '邮件系统', 'OA系统','服务器'],
        inverse: true,
        axisTick: {
            show: false
        },
    ...
    series: [{ // 外边框
            ...
            data: [maxData, maxData, maxData, maxData,maxData],
