            ...
            radar: {
                ...
                splitLine: {
                    ...
                    lineStyle: {
                        width: 1,
                        type:'dashed',
                        color: 'rgba(2, 159, 254, 1)',// 图表背景网格线的颜色
                        opacity: .2
                    },
                },
                splitArea:{
                ...
                indicator: [
                    { name: '发货人', max: 6500, num: 234},
                    { name: '收货人', max: 16000, num: 234},
                    { name: '客户经理', max: 30000, num: 234},
                    { name: '司机', max: 38000, num: 234},
                ],
