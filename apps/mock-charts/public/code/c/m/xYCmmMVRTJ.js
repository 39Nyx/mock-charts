var uploadedDataURL = "/asset/get/s/data-1563026707858-axXiLaPzS.json";
...
myChart.setOption(option = {
    ...
    visualMap: {
        ...
        calculable: true,
        inRange: {
            color: ['#00FF00', '#00FF00', '#00FF00','#00FF00', '#00FF00','yellow','yellow','yellow','red']
        }
