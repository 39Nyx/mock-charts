...
var osmDataURL = "/asset/get/s/data-1599291019905-iGxGcDDJc.json";
...
//读取数据
        ...
        for (var k = 0; k < data_1.length; k += 1) {
            ...
            var opt1 = {
                title: {
                    text: "路网交通速度实变图 " + (Math.floor(k / 2) + 6).toString()+':'+a,
                    left: 10,
                    top: 10,
                    textStyle: {
